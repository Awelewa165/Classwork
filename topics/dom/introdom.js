...
// console.log(divTag);
// let tagId = document.getElementById("text");
// console.log(tagId);
// let tagClass = document.getElementsByClassName("msg");
// console.log(tagClass);
// let tagName = document.getElementsByTagName("p");
// console.log(tagName);
// let queryEl = document.querySelector("p");
// console.log(queryEl);
// let queryAllEl = document.querySelectorAll("p");
...
// let pMTag = document.querySelector("#text");
// console.log(pMTag);
...
// let allPTags = document.querySelectorAll("p");
// // console.log(allPTags);
// allPTags.forEach((singlePTag) => {
// 	// if (singlePTag === singlePTag.includes("msg")) {
// 	// 	continue;
// 	// }
