...
let pTag = document.querySelectorAll("p.msg");
...
// pTag.forEach((singlePTag) => {
// 	singlePTag.textContent = "I'm the new guy";
// });
...
// pTag.forEach((singlePTag) => {
// 	singlePTag.textContent += ". Let me join you here";
// });
...
// const link = document.querySelector("a");
// console.log(link.getAttribute("href"));
// link.setAttribute("href", "https://www.innkeeper.work");
// link.textContent = "innkeeper";
// const success = document.getElementById("text");
// success.setAttribute("id", "error");
// console.log(success.getAttribute("id"));
// success.style.backgroundColor = "orange";
// // here we are creating a style that doesn't exist before
// const bgcolor = document.querySelector("#text");
// success.setAttribute("style", "background-color: green");
...
// let listOfClass = document.querySelector("h1");
// console.log(listOfClass.classList);
// listOfClass.classList.add("error");
// console.log(listOfClass.classList);
...
let arrayContent = Array.from(div.children);
console.log(arrayContent);
// // we see that we have an array. it is not destructive which means that it returns a new value but doesn't change the initial value. we can check this by logging to the console,
// // console.log(section.children);
